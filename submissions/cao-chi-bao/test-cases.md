...
|---|---|---|---|---|---|---|---|
| TC_REQ07_01 | Kiểm tra quyền thêm thành viên của tài khoản không phải thủ thư | Đã đăng nhập tài khoản thành viên | Kiểm tra sự xuất hiện của icon "Thêm thành viên" trên góc phải | Login: ba.nguyen@email.com 
password: password123 | Icon "Thêm thành viên" không xuất hiện | REQ-07 | Decision Table (Phân quyền) |
