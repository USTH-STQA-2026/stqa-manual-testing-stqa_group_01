...
|04|Kiểm tra khả năng check cú pháp email| Hệ thống báo lỗi do email thiếu dấu "."| Thêm thành công thành viên mới với email không hợp lệ|Chức năng không hoạt động|![Alt text](https://github.com/USTH-STQA-2026/stqa-manual-testing-stqa_group_01/blob/main/screenshots/REQ-07_TC04.png)|email không hợp lệ vẫn được thêm thành công|
