...
|-------|---------------|---------------------------|-----------------|---------|-----------|----| 
|01|Đăng nhập vào hệ thống|Đăng nhập thành công với tài khoản trong hệ thống, thất bại nếu tài khoản không tồn tại|Thành công đăng nhập nếu đúng tài khoản và mật khẩu, thông báo mật khẩu hoặc tài khoản sai nếu thất bại|Chức năng hoạt động bình thường|(screenshots/TC01.png)|Email không theo dạng example@gmail.com vẫn có thể đăng nhập bình thường|
